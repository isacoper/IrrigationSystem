...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post plants_url, params: { plant: { humidity: @plant.humidity, name: @plant.name, temperature: @plant.temperature } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { humidity: @plant.humidity, name: @plant.name, temperature: @plant.temperature } }
